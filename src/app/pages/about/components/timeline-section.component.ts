 ...
 */
@Component({
  selector: 'app-about-timeline-section',
    ...
    >
      <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="text-center max-w-3xl mx-auto mb-12">
          ...
          >
            Hitos de nuestra <span class="text-accent">historia</span>
          </h2>
        </div>

        <!-- Timeline -->
        <div class="space-y-8">
          @for (item of timelineItems; track item.year) {
            <div class="relative pl-8">
              ...
              <!-- Card -->
              <div class="bg-white rounded-2xl p-6 shadow-md ml-4">
                <span
                  [class]="
                    'inline-block text-white font-bold text-sm px-3 py-1 rounded-full mb-2 ' +
                    item.badgeColor
                  "
                >
                  {{ item.year }}
...
export class AboutTimelineSectionComponent {
