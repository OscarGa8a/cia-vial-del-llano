      ...
      <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="text-center max-w-3xl mx-auto mb-12">
          ...
          <p class="text-gray-600 text-lg">
            Un equipo profesional y comprometido con tu bienestar
          </p>
        </div>

        <!-- Team cards -->
        <div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-8">
          @for (member of teamMembers; track member.name; let last = $last) {
            <div
              [class]="
                'bg-white rounded-3xl p-6 shadow-lg text-center card-hover' +
            ...
            >
              ...
              <div
                [class]="
                  'w-28 h-28 bg-gradient-to-br rounded-full mx-auto mb-4 flex items-center justify-center ' +
                  member.gradientFrom +
                  ' ' +
                  member.gradientTo
                "
                aria-hidden="true"
              >
                <span class="text-white/50 font-bold text-2xl">
                  {{ member.initials }}
                </span>
              </div>

              <h3 class="font-sans font-bold text-xl text-gray-900 mb-1">
                {{ member.name }}
              </h3>
