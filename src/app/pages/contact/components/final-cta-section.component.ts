 ...
 */
@Component({
  selector: 'app-contact-final-cta-section',
  ...
  template: `
    ...
    >
      ...
      <div class="relative max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        >
          ¿Aún tienes <span class="text-highlight">dudas</span>?
        </h2>

        <p class="text-white/80 text-lg sm:text-xl mb-10 max-w-2xl mx-auto leading-relaxed">
          Nuestro equipo está listo para ayudarte. Escríbenos por WhatsApp
          y te responderemos en minutos.
        </p>
        ...
        <a
          ...
          aria-label="Escribir por WhatsApp para resolver dudas"
        >
          <svg
            width="28"
            height="28"
...
export class ContactFinalCtaSectionComponent {
  ...
  protected readonly whatsappLink = computed(() =>
    this.whatsapp.generateLink(
      'Hola, tengo una duda y me gustaría recibir ayuda.',
    ),
  );
}
