...
/**
 * Final CTA section — full-width gradient banner with a strong WhatsApp
 * call-to-action to convert remaining visitors.
 */
@Component({
  ...
  template: `
    ...
    >
      ...
      <div class="relative max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        >
          ¿Tienes un comparendo?<br>
          <span class="text-highlight">¡No pierdas tu descuento!</span>
        </h2>

        <p class="text-white/80 text-lg sm:text-xl mb-10 max-w-2xl mx-auto leading-relaxed">
          Nuestro equipo está listo para ayudarte. Agenda tu curso hoy y ahorra hasta el 50%
          en el valor de tu multa de tránsito.
        </p>
        ...
        <p class="mt-5 text-white/60 text-sm flex items-center justify-center gap-2">
          <span class="w-2 h-2 rounded-full bg-whatsapp animate-ping inline-block" aria-hidden="true"></span>
