...
@Component({
  ...
  template: `
    <section class="py-20 bg-white" id="descuentos" aria-labelledby="discounts-heading">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="text-center mb-14">
          ...
          <p class="text-text-secondary text-lg max-w-2xl mx-auto">
            Actúa rápido. El porcentaje de descuento depende de cuándo realices el curso después de
            recibir la notificación de tu comparendo.
          </p>
        </div>
        ...
        >
          ...
          <div>
            ...
            <p class="text-sm text-text-secondary mt-1">
              Si no realizas el curso dentro de los plazos establecidos,
              <strong>perderás el derecho al descuento</strong>
