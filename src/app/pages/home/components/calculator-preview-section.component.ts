...
@Component({
  ...
  imports: [RouterLink],
  template: `
    <section class="py-20 bg-white" id="calculadora" aria-labelledby="calc-heading">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <!-- Section header -->
        <div class="text-center mb-14">
          <span
            class="inline-block bg-highlight-light text-highlight-hover text-xs font-bold uppercase tracking-widest px-4 py-1.5 rounded-full mb-4"
          >
            Calcula tu ahorro
          </span>
          <h2
          ...
          <p class="text-text-secondary text-lg max-w-2xl mx-auto">
            Usa nuestra calculadora para conocer el valor de tu multa y cuánto puedes ahorrar con el
            descuento.
          </p>
        </div>
        ...
        <div class="max-w-3xl mx-auto">
          <div class="rounded-3xl border-2 border-border shadow-2xl overflow-hidden">
            ...
            <div class="bg-primary px-8 py-6 flex items-center gap-4">
              <div
                class="w-12 h-12 rounded-xl bg-white/15 flex items-center justify-center"
                aria-hidden="true"
              >
                <svg
                  width="24"
            ...
            <div class="bg-white p-8" aria-hidden="true">
              ...
              <div class="mb-6">
                ...
                <div class="grid grid-cols-2 gap-3">
                  <div
                    class="flex items-center gap-2 p-3 rounded-xl border-2 border-primary bg-primary-lighter cursor-default select-none"
                  >
                    <div
                  ...
                  <div
                    class="flex items-center gap-2 p-3 rounded-xl border-2 border-border cursor-default select-none"
                  >
              ...
              <div class="mb-6">
                ...
                <div
                  class="w-full px-4 py-3 rounded-xl border-2 border-border bg-gray-50 text-text-secondary text-sm flex items-center justify-between cursor-default select-none"
                >
              ...
              <div class="relative">
                <div
                  class="absolute inset-0 backdrop-blur-sm bg-white/70 rounded-xl z-10 flex flex-col items-center justify-center gap-2"
                  aria-hidden="true"
                >
                  <svg
                    width="24"
                  ...
                  <span class="text-sm font-semibold text-primary"
                    >Usa la calculadora completa</span
                  >
                </div>
