    ...
    <section class="py-12 lg:py-16 bg-white">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="max-w-4xl mx-auto">
          <div class="bg-gradient-to-r from-primary to-primary-dark rounded-3xl p-8 lg:p-12 text-center relative overflow-hidden">
            <!-- Background pattern -->
            ...
            <div class="relative z-10">
              ...
              <p class="text-white/80 text-lg mb-8 max-w-xl mx-auto">
                Agenda tu cita y te esperamos en nuestra sede. Te recomendamos agendar para garantizar tu cupo.
              </p>

              <!-- WhatsApp CTA Button -->
              <a
                [href]="whatsappService.generateLink('Hola, quiero agendar una cita para visitarlos')"
                target="_blank"
