      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="grid grid-cols-1 lg:grid-cols-5 gap-8 lg:gap-12">
          ...
          <div class="lg:col-span-2 space-y-6">
            ...
            <div class="bg-white rounded-2xl p-6 shadow-lg border border-border card-hover">
              <div class="flex items-start gap-4">
                ...
                <div class="flex-grow">
                  ...
                  <p class="text-text-secondary mb-3">{{ config.address.city }}, {{ config.address.department }}</p>
            ...
            <div class="bg-white rounded-2xl p-6 shadow-lg border border-border card-hover">
              <div class="flex items-start gap-4">
                <div class="w-12 h-12 bg-highlight/10 rounded-xl flex items-center justify-center flex-shrink-0">
                  <svg
                ...
                <div class="flex-grow">
                  <div class="flex items-center justify-between mb-3">
                    <h3 class="font-sans font-bold text-lg text-text-primary">Horarios de Atención</h3>
                    <span
                  ...
                  <div class="space-y-2">
                    @for (schedule of businessHours.getSchedule(); track schedule.days) {
                      <div class="flex justify-between items-center py-2 border-b border-border last:border-0">
                        ...
                        <span class="font-semibold" [class.text-text-primary]="schedule.open" [class.text-error]="!schedule.open">
                          {{ schedule.hours }}
                        </span>
                      </div>
                    }
              ...
              <div class="flex items-start gap-4">
                ...
                <div class="flex-grow">
                  ...
                  <div class="space-y-3">
                    ...
                    <a
                      [href]="whatsappService.generateLink('Hola, quisiera información sobre nuestra ubicación')"
                      target="_blank"
                      rel="noopener noreferrer"
                      class="flex items-center gap-3 text-whatsapp hover:text-whatsapp-hover transition-colors"
                      aria-label="Escribir por WhatsApp"
                    >
                      <svg class="w-5 h-5 text-whatsapp flex-shrink-0" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
            ...
            <div class="bg-white rounded-2xl p-6 shadow-lg border border-border card-hover">
              <div class="flex items-start gap-4">
                ...
                <div class="flex-grow">
                  <h3 class="font-sans font-bold text-lg text-text-primary mb-2">Correo Electrónico</h3>
                  <a
          ...
          <div class="lg:col-span-3">
            <div class="bg-white rounded-3xl shadow-xl overflow-hidden h-full min-h-[400px] lg:min-h-[600px] relative">
              <!-- Google Maps iframe -->
              <iframe
                [src]="mapSrc"
                width="100%"
              ...
              <!-- Overlay badge -->
              <div class="absolute bottom-4 left-4 bg-white/95 backdrop-blur px-4 py-2 rounded-full text-sm font-bold shadow-sm text-text-secondary">
                Villavicencio, Meta
              </div>
            </div>
          </div>
