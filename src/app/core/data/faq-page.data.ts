...
export const FAQ_PAGE_DATA: CategorizedFaq[] = [
  ...
  },
  {
    ...
    answer:
      'Las infracciones se clasifican por gravedad:<div class="mt-3 space-y-2"><div class="flex items-center gap-3 p-2 bg-info-light rounded-lg"><span class="w-8 h-8 bg-info text-white font-bold rounded-full flex items-center justify-center shrink-0">A</span><span><strong>4 SMDLV</strong> ($189,800) — Infracciones leves</span></div><div class="flex items-center gap-3 p-2 bg-success-light rounded-lg"><span class="w-8 h-8 bg-success text-white font-bold rounded-full flex items-center justify-center shrink-0">B</span><span><strong>8 SMDLV</strong> ($379,600) — Infracciones menores</span></div><div class="flex items-center gap-3 p-2 bg-warning-light rounded-lg"><span class="w-8 h-8 bg-warning text-white font-bold rounded-full flex items-center justify-center shrink-0">C</span><span><strong>15 SMDLV</strong> ($711,750) — Infracciones moderadas</span></div><div class="flex items-center gap-3 p-2 bg-highlight-light rounded-lg"><span class="w-8 h-8 bg-highlight text-white font-bold rounded-full flex items-center justify-center shrink-0">D</span><span><strong>30 SMDLV</strong> ($1,423,500) — Infracciones graves</span></div><div class="flex items-center gap-3 p-2 bg-error-light rounded-lg"><span class="w-8 h-8 bg-error text-white font-bold rounded-full flex items-center justify-center shrink-0">E</span><span><strong>45 SMDLV</strong> ($2,135,250) — Infracciones muy graves</span></div></div><p class="mt-3 text-sm text-text-secondary">* Valores basados en SMDLV 2026: $58,363.5</p>',
  },
  {
    id: 207,
    category: 'Comparendos',
